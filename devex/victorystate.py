...
class VictoryState:
    ...
    def __init__(self) -> None:
        ...
        self.victory_surf = self.big_font.render("<VICTORY>", True, "yellow")
        ...
        self.lasted_surf = self.font.render(
            f"You speedran the game in {minutes}m {seconds}s!",
            True,
            "orange",
        )
        self.message_surf = self.font.render(
            "Press ENTER to go to the main menu", True, "orange"
        )
    ...
    def draw(self):
        ...
        render_at(self.shared.screen, self.victory_surf, "center", (0, -100))
